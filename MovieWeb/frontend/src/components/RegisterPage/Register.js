...
class Register extends Component {
    ...
    validateField(fieldName, value) {
        ...
        let { emailValid, usernameValid, passwordValid, confirmPasswordValid } = this.state;
        switch (fieldName) {
            case 'email':
            ...
            case 'confirmPassword':
                confirmPasswordValid = value.length > 5;
    ...
    validateForm() {
        this.setState({
            formValid:  this.state.emailValid && this.state.usernameValid &&
